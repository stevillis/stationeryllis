...
class ProductViewsTestCase(APITestCase):
    ...
    def test_create_product_with_valid_data(self):
        ...
        response = self.client.post(
            ...
            data=sample_product_with_valid_data
        )
        data = response.data
        ...
        self.assertEqual(
            Decimal(data["commission_percentage"]),
            round(Decimal(2.5), 2)
        )
    ...
    def test_create_product_with_invalid_data(self):
        ...
        with self.subTest("Create Product with empty description should return Bad Request"):
        ...
        with self.subTest("Create Product with empty unit_price should return Bad Request"):
        ...
        with self.subTest("Create Product with negative unit_price should return Bad Request"):
            sample_product_with_invalid_unit_price = {
                "description": "Doritos",
                "unit_price": -1,
                "commission_percentage": 1
        ...
        with self.subTest("Create Product with empty commission_percentage should return Bad Request"):
        ...
        with self.subTest("Create Product with negative commission_percentage should return Bad Request"):
            sample_product_with_invalid_commission_percentage = {
                "description": "Doritos",
                "unit_price": 3,
                "commission_percentage": -1
    ...
    def test_update_product_with_invalid_data(self):
        ...
        with self.subTest("Update Product with empty description"):
            ...
            response = self.client.put(
                path=products_detail_endpoint,
                data=product_updated_data_with_empty_name
            )
    ...
    def test_update_non_existing_product(self):
        ...
        response = self.client.put(
            path=non_existing_product_endpoint,
            data=product_data
        )
    ...
    def test_delete_product(self):
        ...
        with self.subTest("Delete existing Product should return HTTP No Content status code"):
            response = self.client.delete(products_detail_endpoint)

            self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)

        with self.subTest("Delete non existing Product should return HTTP Not Found status code"):
            response = self.client.delete(products_detail_endpoint)
